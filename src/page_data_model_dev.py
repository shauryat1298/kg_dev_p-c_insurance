...
from config import BASE_PATH, ARTIFACTS_PATH, forms_proto_dm_dir_path, forms_png_dir_path, OPENROUTER_MODEL_NAME, extra_body
...
def convert_png_dir_to_proto_dm(form_png_dir_path, form_proto_dm_dir_path):
    ...
    for form_png_path in form_png_paths:
        ...
        proto_dm_response = extract_proto_code_for_llm_response(call_openrouter_llm(form_png_path))
