...
def new_entity_dev_agent(state: ClusterDevState):
    ...
    existing_entity_list = master_kg_entity_collection.get()['ids']
    
    messages = new_entity_dev_prompt(state['section']['proto_heading'], state['section']['description'], state['section']['proto_dm'], existing_entity_list)
